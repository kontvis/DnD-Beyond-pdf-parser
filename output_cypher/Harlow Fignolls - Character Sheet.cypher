...
UNWIND [
  ...
  {name:"Dexterity", roll:14},
  {name:"Constitution", roll:14},
  {name:"Intelligence", roll:19},
  {name:"Wisdom", roll:14},
  {name:"Charisma", roll:17}
] AS attr
...
UNWIND [
  ...
  {name:"Animal Handling", roll:10},
  {name:"Arcana", roll:6},
  {name:"Athletics", roll:2},
  {name:"Deception", roll:11},
  {name:"History", roll:6},
  {name:"Insight", roll:10},
  {name:"Intimidation", roll:11},
  {name:"Investigation", roll:8},
  {name:"Medicine", roll:4},
  {name:"Nature", roll:6},
  {name:"Perception", roll:4},
  {name:"Performance", roll:5},
  {name:"Persuasion", roll:11},
  {name:"Religion", roll:6},
  {name:"Sleight of Hand", roll:4},
  {name:"Stealth", roll:4},
  {name:"Survival", roll:4}
] AS check
